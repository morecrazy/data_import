...
*/
   ...
   public static String Hex_MurmurHash3_x64_128(final byte[] key, final int seed) {
	   long[] ret = MurmurHash3_x64_128(key, seed);
	   StringBuilder sb = new StringBuilder();
	   sb.append(new String(longToHex(ret[0]))).append(new String(longToHex(ret[1])));
	   return sb.toString();
   }
