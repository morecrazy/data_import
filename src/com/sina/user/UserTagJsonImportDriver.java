...
public class UserTagJsonImportDriver extends MTDefaultDriver {
	...
	public static String HOST_PATH="/usr/fengming/host.txt";
	public static Logger logger = org.apache.log4j.Logger.getLogger(UserTagJsonImportDriver.class);


	public UserTagJsonImportDriver() {
	}
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(UserTagJsonImportDriver.class);
		job.setMapperClass(UserTagJsonImportOnlyMap.class);
		job.setInputFormatClass(TextInputFormat.class);
		TextInputFormat.setInputPaths(job, INPUT_FILE);
		Path outpath = new Path(OUTPUT_PATH);
		TextOutputFormat.setOutputPath(job, outpath);
		//job.setReducerClass(UserTagJsonImportReduce.class);
