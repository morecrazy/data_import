    ...
    public void connect() {
        if (!isConnected()) {
            try {
            	...
            	//System.out.println("mmmm:  "+ex.getMessage());
                throw new JedisConnectionException("connect IOException  "+"ip:"+this.getHost()+":"+this.getPort());
            }
        }
    }
...
/*    	if(socket != null)
    ...
    protected String getStatusCodeReply() {
        ...
        {
        	System.out.println("ip:"+this.getHost()+":"+this.getPort());
        	throw e;
        }
    }
